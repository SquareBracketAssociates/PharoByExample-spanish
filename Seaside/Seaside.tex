...
Como hemos mencionado en la sección anterior, las aplicaciones Seaside se \subind{Seaside}{componentes} construyen con \emph{componentes}.
...
El propósito de una aplicación web es crear o ``presentar'' páginas web.  Como mencionamos en \secref{componentes}, cada componente Seaside es responsable de presentarse a sí mismo.  
...
Ten en cuenta que hay dos formas distintas de instanciar el pincel \ct{heading}. La primera forma es establecer el texto directamente enviando el mensaje \ct{heading:}.
