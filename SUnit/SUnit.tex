...
En este caso , tan pronto como la prueba encuentra que primer elemento de la colecci\'on no es \ct{even}, la prueba se detiene.
Sin embargo, usualmente nos gustar\'ia continuar, y ver tambi\'en cu\'antos elementos hay, y qu\'e elementos hay,
no son \ct{even}, y tal vez reportar esta informaci\'on tambi\'en. Puedes hacer lo siguiente:
