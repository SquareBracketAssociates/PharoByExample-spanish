<<<<<<< .mine
% $Author: MirianQ $
% $Date: 2010-05-05 09:24:21 -0300 (mié 05 de may de 2010) $
% $Revision: 32697 $
...
\indmain{SUnit} es un peque\~no pero poderoso framework que admite la creación y despliegue de tests.
Como puede intuirse por su nombre, el dise\~no de \sunit se focaliza en los \emph{Tests unitarios (Unit Tests)}, 
pero de hecho puede ser usado para pruebas de integración asi como tambien para pruebas funcionales.
\sunit fue
originalmente desarrollado por Kent Beck and posteriormente extendido por Joseph
Pelrine y otros para incorporar la idea de recurso el cual describiremos en \secref{resource}.
\index{Beck, Kent}
\index{Pelrine, Joseph}
\seeindex{resource}{test, resource}

El interés en las pruebas y el \ind{Test Driven Development}
no está limitado a \pharo o \st.  
La automatización de pruebas se ha convertido en un sello del movimiento del \ind{Agile software development}, y cualquier desarrollador
interesado en mejorar la calidad de software haría bien en adoptarlo.
De hecho, desarrolladores en muchos lenguajes han llegado a apreciar el poder de las pruebas unitarias, y ahora versiones de
\xUnit{}  existen para muchos lenguajes, entre ellos \ind{Java}, \ind{Python}, \ind{Perl}, .Net y \ind{Oracle}.
...
Este capítulo describe \SUnit~3.3 (la versión actual al momento de esta edición); el sitio web oficial de \sunit es
\url{sunit.sourceforge.net}, donde se pueden encontrar las actualizaciones.
\index{xUnit}
\index{Net@.Net}
...
Automated testing has become a hallmark of the \ind{Agile software development} movement, y cualquier
desarrollador de software interesado en mejorar la calidad del software tendrá exito al adoptarlo..
De hecho, desarrolladores en muchos lenguajes han lleggado a apreciar el poder
de los tests unitarios, y versiones de 
\xUnit{}  existen actualmente para muchos lenguajes, entre ellos \ind{Java}, \ind{Python}, \ind{Perl}, .Net and \ind{Oracle}.
\seeindex{Matrix!free will}{Oracle} % sorry, couldn't resist
%  OSCAR: There was a broken citation here for the xprogramming web site
% I could not figure out what it was supposed to refer to.
Este capitulo describe \SUnit~3.3 (la ultima version al momento de este escrito); el sitio web oficial de \sunit es
\url{sunit.sourceforge.net}, donde se pueden encontrar actualizaciones.
\index{xUnit}
\index{Net@.Net}
