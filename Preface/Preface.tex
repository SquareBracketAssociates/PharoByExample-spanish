...
% 2012-08-31 - NicoPaez tranlated it to Spanish
...
\index{Knight, Alan}
\important{{\bf No te preocupes.}

Los programadores \st principiantes amenudo tienen problemas porque piensan que necesitan entender todos los detalles de como funciona una determinada cosa antes de poder usarla. Esto significa que les lleva un rato antes de que puedan dominar el \ct{Transcript show: 'Hello World'}. Uno de los grandes avances de la OO es la posibilidad de responder a la pregunta ``¿Cómo funciona esto?'' con ``No me importa''.}
%=================================================================
...
\dothis{¡Adelante y lee el siguiente capítulo!}
