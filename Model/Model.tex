...
En lugar de que la busqueda del method lookup empiece en la clase del receptor, comienza en la in the superclass of the class of the method where the \super send occurs.
