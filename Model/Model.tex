...
\begin{itemize}
  ...
  \item \emph{¿Cu\'al es la diferencia entre los env\'ios de \pvind{self} y \pvind{super}?}
...
Se trata de un lenguaje com\'un en \st, al cual Kent Beck denomina ``Interesante valor de retorno'' \cite{Beck97a}:
\index{Beck, Kent}
